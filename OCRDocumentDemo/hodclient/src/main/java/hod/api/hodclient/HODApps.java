...
public class HODApps {
    ...
    public final static String DETECT_FACES = "detectfaces";
    public final static String RECOGNIZE_IMAGES = "recognizeimages";

    public final static String GET_COMMON_NEIGHBORS = "getcommonneighbors";
    public final static String GET_NEIGHBORS = "getneighbors";
    public final static String GET_NODES = "getnodes";
    public final static String GET_SHORTEST_PATH = "getshortestpath";
    public final static String GET_SUB_GRAPH = "getsubgraph";
    ...
    public final static String RETRIEVE_QUERY_PROFILE = "retrievequeryprofile";
    ...
    public final static String CREATE_TEXT_INDEX = "createtextindex";
    public final static String DELETE_TEXT_INDEX = "deletetextindex";
    public final static String DELETE_FROM_TEXT_INDEX = "deletefromtextindex";
    public final static String INDEX_STATUS = "indexstatus";
